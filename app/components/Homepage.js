...
const Homepage = () => {
  ...
  useEffect(() => {
    gsap.fromTo(".Image", { opacity: 0, scale: 0 }, { opacity: 1, scale: 1 });
    gsap.from(".Tools", {
      duration: 1,
      y: 10,
      opacity: 0,
  ...
  return (
    <>
      ...
      {showWelcomeOverlay && <div className="fixed inset-0 z-40 bg-black bg-opacity-20 backdrop-blur-sm transition-all duration-300"></div>}

      <div className={`${showWelcomeOverlay ? "pointer-events-none" : ""}`}>
        <section className="Image py-16 px-4 sm:px-6 lg:px-8">
        ...
        <section className="Tools py-4 px-4 sm:px-6 lg:px-8 bg-white/80">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="group hover:shadow-lg transition-all duration-300 bg-white/80 backdrop-blur-sm cursor-pointer border-none rounded-xl p-4">
                <CardHeader className="p-0 mb-4">
                  ...
                  <CardTitle className="group-hover:text-pink-600 transition-colors text-xl font-semibold">Feeding Schedule</CardTitle>
                  <CardDescription className="text-gray-600 text-sm">Track feeding times, amounts, and create custom schedules</CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card className="group hover:shadow-lg transition-all duration-300 bg-white/80 backdrop-blur-sm cursor-pointer border-none rounded-xl p-4">
                <CardHeader className="p-0 mb-4">
                  ...
                  <CardTitle className="group-hover:text-blue-600 transition-colors text-xl font-semibold">Inventory Tracker</CardTitle>
                  <CardDescription className="text-gray-600 text-sm">Monitor baby essentials and get low stock alerts</CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card className="group hover:shadow-lg transition-all duration-300 bg-white/80 backdrop-blur-sm cursor-pointer border-none rounded-xl p-4">
                <CardHeader className="p-0 mb-4">
                  ...
                  <CardTitle className="group-hover:text-purple-600 transition-colors text-xl font-semibold">Memory Vault</CardTitle>
                  <CardDescription className="text-gray-600 text-sm">Capture precious moments and share with community</CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card className="group hover:shadow-lg transition-all duration-300 bg-white/80 backdrop-blur-sm cursor-pointer border-none rounded-xl p-4">
                <CardHeader className="p-0 mb-4">
                  ...
                  <CardTitle className="group-hover:text-green-600 transition-colors text-xl font-semibold">Vaccine Tracker</CardTitle>
                  <CardDescription className="text-gray-600 text-sm">Track vaccinations and upload medical records</CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card className="group hover:shadow-lg transition-all duration-300 bg-white/80 backdrop-blur-sm cursor-pointer border-none rounded-xl p-4">
                <CardHeader className="p-0 mb-4">
                  ...
                  <CardTitle className="group-hover:text-orange-600 transition-colors text-xl font-semibold">Parent Resources</CardTitle>
                  <CardDescription className="text-gray-600 text-sm">Videos, articles, and expert advice</CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card className="group hover:shadow-lg transition-all duration-300 bg-white/80 backdrop-blur-sm cursor-pointer border-none rounded-xl p-4">
                <CardHeader className="p-0 mb-4">
                  ...
                  <CardTitle className="group-hover:text-teal-600 transition-colors text-xl font-semibold">FAQs</CardTitle>
                  <CardDescription className="text-gray-600 text-sm">Quick answers to common baby care questions</CardDescription>
                </CardHeader>
              </Card>
            </div>
          </div>
        ...
        <section id="about" className="about py-4 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto max-w-5xl">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-4 text-gray-8000 leading-tight">Why Mothers Trust NeoNest</h2>
        ...
        <section className="px-4 sm:px-6 lg:px-8 bg-white/80 py-16">
          <div className="container mx-auto max-w-6xl">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
              <h2 className="text-3xl font-bold text-gray-800 text-center mt-6 md:text-left">Read how NeoNest helped parents</h2>
              <div className="text-center md:text-right">
                <Button variant="outline" className="text-pink-600 border-pink-400 font-semibold hover:bg-pink-50 px-6 py-2 rounded-full" onClick={handleAddReviewClick}>
                  + Add Your Review
                </Button>
              </div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {userReview && (
                <Card className="bg-white/90 border border-green-300 shadow-lg p-4 rounded-xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
                  <CardHeader className="p-0 mb-3">
                    <CardTitle className="text-lg text-gray-800 font-semibold">{userReview.name}</CardTitle>
                    <CardDescription className="text-sm text-green-600">#{userReview.tag}</CardDescription>
                  </CardHeader>
                  <CardContent className="p-0">
                    <p className="text-gray-700 text-base mb-3">{userReview.content}</p>
                    <div className="text-xs text-gray-500 mb-2">Tags: {userReview.keywords.map((word) => `"${word}"`).join(", ")}</div>
                  </CardContent>
                </Card>
              )}
              ...
              {featuredReviews.map((review, index) => {
                ...
                return (
                  <Card key={index} className="bg-white/90 border border-gray-200 shadow-md p-4 rounded-xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
                    <CardHeader className="p-0 mb-3">
                      <CardTitle className="text-lg text-gray-800 font-semibold">{review.name}</CardTitle>
                      <CardDescription className="text-sm text-pink-600">#{review.tag}</CardDescription>
                    </CardHeader>
                    <CardContent className="p-0">
                      <p className="text-gray-700 text-base mb-3">{review.content}</p>
            ...
            <div className="text-center mt-8">
              <Button variant="outline" className="text-pink-600 border-pink-400 font-bold hover:bg-pink-50 px-8 py-3 rounded-full">
                View All Reviews →
              </Button>
            </div>
          </div>
